...
output_TT %>% 
	...
	ggplot(aes(x = temperature, y = log(K))) + geom_point(size = 4, alpha = 0.5, color = "blue") + geom_smooth(method = lm) + theme_bw() + ylab("ln K (biovolume um3/ml)") + xlab("temperature (C)") + theme(text = element_text(size=20))
